...
### 4. Logistics
- **Standard Class** handles the majority of orders (43 out of 55), with an average 
  shipping time of 168 days
- **First Class** averages 71 days, while **Same Day** is not present in this dataset subset
- The **East region** shows the shortest average shipping time (77.8 days), 
  while **West** has the longest (158.8 days)
- All three customer segments prefer Standard Class shipping
